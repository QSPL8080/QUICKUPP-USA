...
export const data: ServicePageData = {
  ...
  blocks: [
    {
      type: "list",
      title: "Our Digital Twin Services",
      items: [
        "Digital Twin Setup",
        "AI Digital Twin Creation",
        "AI Avatar Creation",
        "Voice Clone Integration",
        "Digital Clone Video Production",
    ...
    },
    {
      ...
      desc:
        "Create consistent video content for social media, marketing campaigns, sales communication, training and customer engagement.",
    },
    {
      type: "list",
