...
export const data: ServicePageData = {
  ...
  heroParagraphs: [
    "Reach customers directly through personalized WhatsApp conversations, campaigns and automated communication.",
    "Quickupp Softech provides WhatsApp Marketing Services to help businesses generate leads, promote offers, nurture prospects, provide customer support and increase conversions through WhatsApp.",
  ],
  heroCta: { label: "Get Your WhatsApp Marketing Strategy", href: "/contact" },
  blocks: [
    {
      type: "list",
      title: "Our WhatsApp Marketing Services",
      items: [
      ...
      items: [
        {
          ...
          a: "WhatsApp marketing uses WhatsApp to communicate with customers, promote products or services, generate leads and build customer relationships.",
        },
        {
          q: "Do you provide WhatsApp Automation?",
          a: "Yes. We can create automated workflows for lead follow-ups, customer communication and engagement.",
        },
        {
          q: "Can WhatsApp Marketing generate leads?",
          a: "Yes. WhatsApp campaigns can help businesses connect with interested prospects and move them through the sales journey.",
        },
      ],
    },
  ],
