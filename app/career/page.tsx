      ...
      <section className="sc-choice-section">
        <div className="w-layout-blockcontainer container w-container">
          ...
          <div className="sc-choice-grid">
            ...
            {/* Right Sleek Feature List */}
            <div className="sc-choice-list">
              <div className="sc-choice-item-row">
                <div className="sc-choice-item-icon">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <polyline points="23 6 13.5 15.5 8.5 10.5 1 18" />
                    <polyline points="17 6 23 6 23 12" />
                  </svg>
                </div>
                <div className="sc-choice-item-body">
                  <div className="sc-choice-item-title">Proven Impact &amp; Results</div>
                  <p className="sc-choice-item-desc">
                    We eliminate corporate fluff, focusing 100% on high-ROI marketing, AI automation &amp; resilient software.
                  </p>
                </div>
              </div>
              ...
              <div className="sc-choice-item-row">
                ...
                <div className="sc-choice-item-body">
                  ...
                  <p className="sc-choice-item-desc">
                    Work from anywhere in the world on high-impact projects with flexible, asynchronous freedom.
                  </p>
                </div>
              </div>
              ...
              <div className="sc-choice-item-row">
                ...
                <div className="sc-choice-item-body">
                  ...
                  <p className="sc-choice-item-desc">
                    Full access to OpenAI, Claude 3.5, Cursor, and enterprise-grade cloud compute infrastructure.
                  </p>
                </div>
              </div>
              ...
              <div className="sc-choice-item-row">
                ...
                <div className="sc-choice-item-body">
                  ...
                  <p className="sc-choice-item-desc">
                    Fast-track promotions, performance profit shares, continuous learning, and direct founder mentorship.
                  </p>
                </div>
              </div>
            </div>
